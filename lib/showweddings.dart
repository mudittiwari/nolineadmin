...
class showweddings extends StatefulWidget {
  final user;
  final String type;
  const showweddings(this.user, this.type);
  @override
  _showweddingsState createState() => _showweddingsState();
}

class _showweddingsState extends State<showweddings> {
