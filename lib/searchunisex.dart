...
class searchunisex extends StatefulWidget {
  @override
  _searchunisexState createState() => _searchunisexState();
}

class _searchunisexState extends State<searchunisex> {
        ...
        searchone = Container(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return searchresuni(context, tempSearchStore1[index]);
            },
