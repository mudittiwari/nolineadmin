...
class addparlour extends StatefulWidget {
  final value;
  addparlour(this.value);
  @override
  _addparlourState createState() => _addparlourState();
}

class _addparlourState extends State<addparlour> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: DoubleBackToCloseApp(
        snackBar: SnackBar(content: Text("Please create parlour")),
        child: FutureBuilder(
          future: getamen(),
