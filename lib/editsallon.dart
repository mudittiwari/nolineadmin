...
class editsallon extends StatefulWidget {
  final value;
  editsallon(this.value);
  @override
  _editsallonState createState() => _editsallonState();
}

class _editsallonState extends State<editsallon> {
