...
import 'package:noline_admin/editunisex.dart';
import 'package:url_launcher/url_launcher.dart';

class unisexprofile extends StatefulWidget {
  final name;
  var ls;
  unisexprofile(this.name, this.ls);
  @override
  _unisexprofileState createState() => _unisexprofileState();
}

class _unisexprofileState extends State<unisexprofile> {
