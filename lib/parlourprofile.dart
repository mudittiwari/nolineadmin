...
import 'package:noline_admin/editparlour.dart';
import 'package:url_launcher/url_launcher.dart';

class parlourprofile extends StatefulWidget {
  final name;
  var ls;
  parlourprofile(this.name, this.ls);
  @override
  _parlourprofileState createState() => _parlourprofileState();
}

class _parlourprofileState extends State<parlourprofile> {
