...
class addunisex extends StatefulWidget {
  final value;
  addunisex(this.value);
  @override
  _addunisexState createState() => _addunisexState();
}

class _addunisexState extends State<addunisex> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: DoubleBackToCloseApp(
        snackBar: SnackBar(content: Text("Please create unisex sallon")),
        child: FutureBuilder(
          future: getamen(),
